...
/**
 * Created by Marco on 2017-08-27.
 */
...
public class JSONHelper {
    ...
    public static boolean exportToJSON(Context context, List<DataItem> dataItemList){
        ...
        // Could also actually just pass the dataItemList directly, not sure why we create an object containing it
//      String jsonString = gson.toJson(dataItemList);
